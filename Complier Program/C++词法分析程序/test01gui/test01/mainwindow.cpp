...
void MainWindow::on_produceCPP_clicked()
{
    ...
    //生成代码
    code->initCode("example.tny", "test.lex");  //需要改
...
void MainWindow::on_saveLex_clicked()
{
    ...
    tnyPath=QFileDialog::getOpenFileName(nullptr,"Open File",QDir::currentPath(),".tny Files(*.tny)");
    if(tnyPath.isEmpty()){
        qDebug()<<"No file selected!";
        return;
    }
    ...
    ui->terLines->append(QString::fromStdString("Write ")+lexPath+QString::fromStdString(" complete!")); //终端显示
...
void MainWindow::on_openFile_triggered()
{
    ...
    ui->terLines->append(QString::fromStdString("Reading ")+reRulePath+QString::fromStdString(" complete!")); //终端显示
}
